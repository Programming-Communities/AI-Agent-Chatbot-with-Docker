...
# Optionally, print the API keys (not recommended for production)
...
# groq_api_key = os.getenv("GROQ_API_KEY", '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')  # Groq API key
# os.environ["TAVILY_API_KEY"] = os.getenv("TAVILY_API_KEY", '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')  # Set Tavily API key
...
MODEL_NAMES = [
    ...
    "llama3.2-vision:11b",    # From Ollama list
    "starcoder:latest",       # From Ollama list
    "llama2:7b"               # From Ollama list
]
